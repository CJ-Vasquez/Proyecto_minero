...
export const routes: Routes = [
  ...
  { path: 'login', component: LoginComponent },
  {
    ...
    children: [
      ...
      { path: 'recepciones', loadComponent: () => import('./pages/recepciones/recepciones.component').then(m => m.RecepcionesComponent) },
      ...
      { path: 'usuarios', loadComponent: () => import('./pages/usuarios/usuarios.component').then(m => m.UsuariosComponent), canActivate: [RoleGuard], data: { roles: ['ADMIN'] } },
